...
$ACCESS_PWD='H@W=P6TAZz]I'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=> "shopiapp_tyrelat",#required
 'pwd'=> "tyrelat121*1", #required
 'db'=> "shopiapp_testupsell",  #optional, default DB
