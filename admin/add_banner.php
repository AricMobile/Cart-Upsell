                            ...
                            <div class="section-row" style="width:420px">
                                <div class="section-cell"  style="box-shadow: none;">
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="text" class="demo input_field" id="bSubTitle" placeholder="Banner Sub Title" value="" /> 
                                        </div>
                                    </div>
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="text" class="demo input_field" id="bTitleInternal" placeholder="Banner Internal Title" value="" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            ...
                                            <div class="selected_pro_upsell_list"></div>
                                            <input type="hidden" id="b_product_list" value="" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            ...
                                            <div class="selected_pro_target_list"></div>
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input checked='checked' type="checkbox" name="b_banner_visiblity[]" class="b_banner_visiblity" value="Cart" />
                                        </div>
                                    </div>
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="checkbox" class="b_banner_visiblity" name="b_banner_visiblity[]" value="Checkout" />
                                        </div>
                                    </div>
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="radio" checked='checked' class="b_Templates" name="b_Templates" value="h" /> Horizontal<br>
											<input type="radio" class="b_Templates" name="b_Templates" value="v" /> Vertical<br>
											<input type="radio" class="b_Templates" name="b_Templates" value="f" />Featured (Single Product)<br>
                                        </div>
                                    </div>
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="radio" class="b_in_page_banner" id="b_in_page_banner" name="b_in_page_banner" value="1" />
                                        </div>
                                    </div>
...
<script>
	...
	$(document).on('click', '.p_c_add`', function () {
	});
